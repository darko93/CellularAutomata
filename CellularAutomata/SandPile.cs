...
namespace CellularAutomata
{
    ...
    {        
        ...
        public void SetRandomCellsState(int cellsPercentage, SandPileCellState cellState, Point leftBottomBound, Point rightTopBound)
        {
        ...
        public void SetRandomCellsState(int cellsPercentage, SandPileCellState cellState)
        {
        ...
        public void SetRandomCellsState(int cellsPercentage, SandPileCellState cellState, Point location, int width, int height)
        {
